...
import featuredProject from "../assets/images/portfolio_propinquity.png";
import featuredExperience from "../assets/images/experience_canassist.png";
      ...
      <Container className={"home-page"} sx={{overflowX: "hidden"}}>
        ...
        <Grid container spacing={2} marginTop={4}>
          <Grid size={{xs: 12, md: 6}}>
            ...
            <Card
              title={"Propinquity"}
              imgSource={featuredProject}
              imgAlt={"Logo for my new propinquity app"}
              bodyText={
                <MarkdownToHTML
                  src={"content/projects/ProjectPropinquity.md"}
                />
              }
            />
          </Grid>
          <Grid size={{xs: 12, md: 6}}>
            ...
            <Card
              title={"Software Developer at CanAssist"}
              imgSource={featuredExperience}
              imgAlt={
                "Picture from CanAssist featuring Dion, Dylan, Patrick, and Me"
              }
              bodyText={
                <MarkdownToHTML
                  src={"content/experience/ExperienceCanAssistShort.md"}
                />
              }
            />
          </Grid>
